    ...
    return (
        <div>
            ...
            <div className="mt-2">
                ...
                <input onChange={handleAdditionalCharge} type="number" name="price" id="price" className="block min-w-0 grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6" placeholder="0.00" />
